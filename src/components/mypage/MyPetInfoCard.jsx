            ...
            >
              <Row>
                ...
                >
                  {/* ✅ SecureImage로 교체 */}
                  {pet.imagePath ? (
                    <SecureImage src={pet.imagePath} alt={pet.name} />
                  ) : (
                    <div
                      style={{
                        width: "100%",
                ...
                <Col sm={7} style={{ position: "relative" }}>
                  <Dropdown
                    className="profile-dropdown mx-4"
                  ...
                  >
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item onClick={() => handleDelete(pet.petId)}>
                        삭제
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
